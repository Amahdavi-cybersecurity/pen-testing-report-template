...
## Project Overview
This project delivers a fully-featured penetration testing plan and report covering every test phase, from rules of engagement and reconnaissance through exploitation, findings, and remediation. 
